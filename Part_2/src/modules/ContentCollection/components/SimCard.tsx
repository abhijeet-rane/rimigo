...
import { LIGHTING_BOLT_ICON } from '@/constants/thiingsIcons'
...
const SimCard: React.FC<SimCardProps> = ({ section, isRimigoInternal = false, onEdit, onDelete }) => {
        ...
        <div className="flex flex-col gap-0.5">
            {items.map((item, itemIndex) => (
                <LinkItem
                    ...
                    fallbackIcon={LIGHTING_BOLT_ICON}
